...
\begin{figure}[htbp]
\includegraphics[width=0.40\columnwidth]{fpAbsorbfig_alt}
...
\begin{figure}[!htbp]
\includegraphics[width=0.40\columnwidth]{etalon_trans.pdf}
...
\begin{figure}[htbp]
\includegraphics[width=1.0\columnwidth]{VS20fineGapCrop.pdf}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=0.4\columnwidth]{VS2021_IR_image.pdf}
\caption{
...
\begin{figure}[htbp]
        ...
        \begin{subfigure}[b]{0.5\textwidth}
              \includegraphics[width=\textwidth]{VG03_corner.pdf}
              \caption{Fitted gap size $d$ and fill factor $f$ for VG03 hole region}
		\label{figVG03_corner}
        \end{subfigure}

        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{VG03_f100.pdf}
...
\begin{figure}[htbp]
        \centering
        \begin{subfigure}[b]{0.5\textwidth}
              \includegraphics[width=\textwidth]{VG03p2_corner.pdf}
              \caption{Fitted gap size $d$ and fill factor $f$ for VG03 petal region}
		\label{figVG03p2_corner}
        \end{subfigure}

        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{VG03_f045.pdf}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.35\textwidth}
        \includegraphics[width=\textwidth]{VG09_12_STA_illustration.pdf}
        \caption{Illustration of VG09-12 sample transport accessory measurement positions. \label{figVG0912_STA_illus} }
    \end{subfigure}
    \begin{subfigure}[b]{0.65\textwidth}
        \includegraphics[width=\textwidth]{VG0912_STA_scan_coarse.pdf}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{VG0912_0gap_corner.pdf}
        \caption{Fitted gap size $d$ and fill factor $f$ for VG09-12 off-mesh}
	\label{VG0912_0gap_corner}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{VG0912_0gap.pdf}
...
\begin{figure}[htbp]
\includegraphics[width=0.8\columnwidth]{F1250_10_filter.pdf}
...
\begin{figure}[htbp]
\includegraphics[width=0.8\columnwidth]{FB1250-10_integ_trans.pdf}
...
\bibitem{doi:10.1080/02786828608959094}
