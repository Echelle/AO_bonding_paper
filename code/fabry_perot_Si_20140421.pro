...
oplot, wl, pred3.t_dsp, color=0, linestyle=0, thick=3.0
oplot, wl, pred3.t_net, color=255, linestyle=2, thick=3.0
oplot, wl, pred4.t_net, color=100, linestyle=4, thick=3.0


    
AL_Legend, ['No gap', '20 nm gap', '35 nm gap'], $
linestyle=[0, 2, 4], thick=[3,3,3], Color=[0, 255, 100], Position=[1300,0.555] 
