...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\columnwidth]{figs/20140421_absolute.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\columnwidth]{figs/20140421_absoluteB.pdf}}
...
It is clear that in the limit $\lim_{d \rightarrow 0}$, the etalon approaches 100\% transmission.  Figure \ref{figEtalonRelTrans} shows a plot of Equation \ref{eqFP} for gap sizes, $d$, of 20 nm and 35 nm.  In the next section we compare measurements to by-eye fits of this equation.
