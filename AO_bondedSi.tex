...
\subsection{Measurement of a sample with no implanted gaps}
We measured direct bonded Si$-$Si sample (part VG02, Table \ref{tbl_experiments}) with no intentionally embedded gaps.  We measured transmission spectra in four randomly chosen regions of the $100\;$mm bonded wafers, with no preparatory imaging available.  Two of the regions showed evidence of large ($>\lambda$) gaps.  The other two regions showed almost 100\% transmission, when normalized by measurements of $T_{DSP}$.  We apply our formalism to one of these regions to get an estimate for the smallest gap that we can constrain.  Figure \verb|\ref{fig_xxx}| shows a zoom in of the measured normalized transmission spectrum, which shows strongly correlated noise, especially in the wavelength range $2000-2500\;$nm.
