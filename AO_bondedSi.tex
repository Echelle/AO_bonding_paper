...
\caption{Ratio of transmission of a 0.5 mm thick Si wafer to that of a 3.0 mm thick Si puck.  \label{figSiAbsorbfig} We detect Si absorption shortward of $\lambda \; =$ 1250 nm.  We assume spectral regions longward of 1250 nm are non-absorptive.  The correlated and heteroscedastic measurement errors are typically less than 0.2\%.}
\end{figure}
