...
At this stage, \emph{any} regression technique can be employed to compare the Fabry-P\'{e}rot to data.  Least squares regression and other popular methods can be applied easily.  
