...
\begin{figure}[htbp]
\centerline{\includegraphics[width=.5\columnwidth]{figs/SiBondParticle.pdf}}
\caption{Schematic of a particle preventing bonding of two Si surfaces\label{figParticle}}
\end{figure}
